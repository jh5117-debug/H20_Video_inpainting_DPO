...
from training.common.experiment import prepare_experiment_dir, resolve_output_dir
...
def build_stage1_cmd(project_root, args):
    ...
    return cmd, data_dir, weights_dir, str(output_dir)
...
def run_stage1(args=None):
    ...
    cmd, data_dir, weights_dir, output_dir = build_stage1_cmd(project_root, args)
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default=None,
                        help="显式输出目录。默认写入 experiments/sft/stage1/")

...
export MASK_DILATION_ITER=0
export MASK_AREA_MIN=0.20
export MASK_AREA_MAX=0.30
export MASK_MARGIN_RATIO=0.10

export NEG_QUALITY_MIN=0.30
export NEG_QUALITY_MAX=0.65
export NEG_QUALITY_TARGET=0.45
